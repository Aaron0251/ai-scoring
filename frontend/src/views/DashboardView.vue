  ...
  <AppLayout>
    <div class="dashboard" v-loading="loading">
      ...
      <el-row :gutter="16" style="margin-bottom:16px">
        <el-col :span="12">
          <el-card>
            <template #header><span>部門優先序矩陣（優先序 vs 進度）</span></template>
            <v-chart :option="scatterOption" style="height:280px" autoresize />
          </el-card>
        </el-col>
        <!-- 開發工具 Treemap -->
        <el-col :span="12">
          <el-card>
            <template #header><span>開發工具占比</span></template>
            <v-chart :option="treemapOption" style="height:280px" autoresize />
          </el-card>
        </el-col>
      </el-row>
