  ...
  <AppLayout>
    <div v-loading="loading">
      <div class="toolbar">
        ...
        <div v-if="auth.isAdmin || auth.isManager || auth.isExecutive">
            ...
            <el-row :gutter="24">
              <el-col :xs="24" :sm="12" :md="8">
                <div class="form-field">
                  ...
                  <el-select v-else v-model="form.divisionId" clearable placeholder="選擇本部" style="width:100%" :disabled="(auth.isChief || auth.isManager) && !auth.isAdmin && !auth.isExecutive" @change="onDivisionChange">
          ...
          <el-card shadow="hover">
            <template #header>
              <div style="display:flex;justify-content:space-between;align-items:center;width:100%">
                ...
                <el-button v-if="auth.isAdmin || auth.isManager || auth.isExecutive" type="primary" size="small" @click="openLogDialog(null)">
                  + 新增日誌
                </el-button>
              </div>
            </template>
            <el-table :data="executionLogs" border size="small" empty-text="尚無執行日誌" max-height="500">
              ...
              <el-table-column v-if="auth.isAdmin || auth.isManager || auth.isExecutive" label="操作" width="120" align="center" fixed="right">
                <template #default="{row}">
